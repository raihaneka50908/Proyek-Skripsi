...
## Generated on : Wed Nov 30 11:42:22 2022
## Final product: $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/raspi_googlenet_trash_class.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/codegen/exe/raspi_googlenet_trash_class
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/raspi_googlenet_trash_class.elf
...
%.c.o : $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/D/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/Trained_Model/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
