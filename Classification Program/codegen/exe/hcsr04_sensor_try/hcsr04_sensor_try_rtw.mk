###########################################################################
## Makefile generated for component 'hcsr04_sensor_try'. 
## 
## Makefile     : hcsr04_sensor_try_rtw.mk
## Generated on : Tue Jun 14 11:43:25 2022
## Final product: $(MATLAB_WORKSPACE)/E/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/hcsr04_sensor_try.elf
...
PRODUCT_NAME              = hcsr04_sensor_try
MAKEFILE                  = hcsr04_sensor_try_rtw.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/E/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/codegen/exe/hcsr04_sensor_try
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(MATLAB_WORKSPACE)/E/For_Learning/My_Future_Skripsi/Program_Raspberry_Pi/Classification_Program/hcsr04_sensor_try.elf
...
DEFINES_ = -D_POSIX_C_SOURCE=199309L -DMW_PWMBLOCK -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_MATLABTARGET
DEFINES_CUSTOM = 
DEFINES_SKIPFORSIL = -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=200000
DEFINES_STANDARD = -DMODEL=hcsr04_sensor_try
...
SRCS = $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/MW_video_display.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/MW_pigs.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/system.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/devices.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/GPIO.c $(START_DIR)/hcsr04_sensor_try_main_terminate.cpp $(START_DIR)/hcsr04_sensor_try_data.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp $(START_DIR)/hcsr04_sensor_try_initialize.cpp $(START_DIR)/hcsr04_sensor_try_terminate.cpp $(START_DIR)/hcsr04_sensor_try.cpp $(START_DIR)/fileManager.cpp $(START_DIR)/pause.cpp $(START_DIR)/tic.cpp $(START_DIR)/toc.cpp $(START_DIR)/examples/main.cpp $(START_DIR)/SDLVideoDisplay.cpp $(START_DIR)/raspi.cpp $(START_DIR)/GPIOCodegen.cpp $(START_DIR)/PWMBlock.cpp $(START_DIR)/PWMBase2.cpp $(START_DIR)/hcsr04_sensor_try_rtwutil.cpp $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/server/MW_raspi_init.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c
...
OBJS = MW_video_display.c.o MW_pigs.c.o system.c.o devices.c.o GPIO.c.o hcsr04_sensor_try_main_terminate.cpp.o hcsr04_sensor_try_data.cpp.o rt_nonfinite.cpp.o rtGetNaN.cpp.o rtGetInf.cpp.o hcsr04_sensor_try_initialize.cpp.o hcsr04_sensor_try_terminate.cpp.o hcsr04_sensor_try.cpp.o fileManager.cpp.o pause.cpp.o tic.cpp.o toc.cpp.o main.cpp.o SDLVideoDisplay.cpp.o raspi.cpp.o GPIOCodegen.cpp.o PWMBlock.cpp.o PWMBase2.cpp.o hcsr04_sensor_try_rtwutil.cpp.o MW_raspi_init.c.o MW_Pyserver_control.c.o
...
hcsr04_sensor_try_main_terminate.cpp.o : $(START_DIR)/hcsr04_sensor_try_main_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


hcsr04_sensor_try_data.cpp.o : $(START_DIR)/hcsr04_sensor_try_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
hcsr04_sensor_try_initialize.cpp.o : $(START_DIR)/hcsr04_sensor_try_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


hcsr04_sensor_try_terminate.cpp.o : $(START_DIR)/hcsr04_sensor_try_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


hcsr04_sensor_try.cpp.o : $(START_DIR)/hcsr04_sensor_try.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


fileManager.cpp.o : $(START_DIR)/fileManager.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
hcsr04_sensor_try_rtwutil.cpp.o : $(START_DIR)/hcsr04_sensor_try_rtwutil.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
