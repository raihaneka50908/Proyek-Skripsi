...
namespace coder
{
  ...
  void b_raspi::b_configurePin()
  {
    raspi::internal::GPIOCodegen gpioObj;
    int ret;
    this->configurePinUnset(20.0);
    gpioObj.init();
    ret = raspi::internal::GPIOCodegen::initGPIO(20.0, 0.0);
    if (ret == 0) {
      this->registerPinMode(20.0, 2.0);
    }
  }
  ...
  {
    raspi::internal::GPIOCodegen gpioObj;
    if (this->DigitalPin[20].Mode == 1.0) {
      this->configurePin();
    }

    if ((!this->DigitalPin[20].Available) || (!(this->DigitalPin[20].Mode == 3.0)))
    {
    ...
    gpioObj.init();
    raspi::internal::GPIOCodegen::writeGPIO(21.0, 0.0);
  }
  ...
  void b_raspi::configurePin()
  {
    ...
    int ret;
    this->configurePinUnset(21.0);
    raspiGPIO.init();
    ret = raspi::internal::GPIOCodegen::initGPIO(21.0, 1.0);
    if (ret == 0) {
      this->registerPinMode(21.0, 3.0);
    }
  }
  ...
  bool b_raspi::readDigitalPin()
  {
    ...
    gpioObj.init();
    return raspi::internal::GPIOCodegen::readGPIO(20.0);
  }
  ...
  void b_raspi::writeDigitalPin()
  {
    ...
    gpioObj.init();
    raspi::internal::GPIOCodegen::writeGPIO(21.0, 1.0);
  }
}
